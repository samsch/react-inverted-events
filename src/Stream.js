...
const withStream = Component => props => (
  <Consumer>
    {stream => (
...
export const Stream = withStream(class Stream extends React.Component {
  constructor(props) {
    super(props);
    this.makeOwnStream = memoize((parentStream, contextStream) => Kefir.merge([parentStream, contextStream.stream]));
  }
  componentDidMount() {
